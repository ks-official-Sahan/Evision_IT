...
function BlogContent({ locale }: BlogClientContentProps) {
  ...
  return (
    <>
      ...
      >
        <Container size="sm">
          <Breadcrumbs items={[{ label: "Blog", href: `/${locale}/blog` }]} />
          ...
          <div className="mt-8 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
              Stay updated with our latest articles on digital transformation,
              IT strategy, and industry trends.
            </p>
          </div>
        </Container>
      </Section>
...
export function BlogClientContent({ locale }: BlogClientContentProps) {
  return (
