        ...
        <div className="mt-12 pt-12 border-t border-border text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8">
            ...
            <div className="h-12 px-6 bg-muted/30 rounded-lg flex items-center">
              <span className="text-muted-foreground text-sm font-medium">Client Logo 1</span>
            </div>
            <div className="h-12 px-6 bg-muted/30 rounded-lg flex items-center">
              <span className="text-muted-foreground text-sm font-medium">Client Logo 2</span>
            </div>
            <div className="h-12 px-6 bg-muted/30 rounded-lg flex items-center">
              <span className="text-muted-foreground text-sm font-medium">Client Logo 3</span>
            </div>
            <div className="h-12 px-6 bg-muted/30 rounded-lg flex items-center">
              <span className="text-muted-foreground text-sm font-medium">Client Logo 4</span>
            </div>
            <div className="h-12 px-6 bg-muted/30 rounded-lg flex items-center">
              <span className="text-muted-foreground text-sm font-medium">Client Logo 5</span>
            </div>
          </div>
        </div>
      </Container>
